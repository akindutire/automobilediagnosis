...
<title>Auto repair|Add Clent</title>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530">
            ...
            <div class="header_02">New Client</div>
            ...
            <div id="feedback" style="background:transparent; color:black; font-size:18px; padding:1px; margin:1% 32% 2px 32%; height:auto; width:350px; text-align:center; border-radius:3px;"></div>
           	...
           	<form action="../process/add.php" method="post">
                	...
                	<div class="all"><label>Vehicle Owner</label><input type="text" name="owner" id="owner" required="required"></div>
                	<div class="all"><label>Vehicle Name</label><input type="text" name="car" id="car" required="required"></div>
                	<div class="all"><label>Address</label><input type="text" name="addr" id="addr" required="required"></div>
                	<div class="all"><label>Mail</label><input type="email" name="mail" id="mail" required="required"></div>
                	<div class="all"><label>Telephone</label><input type="tel" name="tel" id="tel" required="required"></div>
					<div class="all"><label></label><button type="submit" id="sbaddclient">Enter</button></div>
