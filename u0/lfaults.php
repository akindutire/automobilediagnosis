...
<title>Auto repair| Add Knowledge</title>
...
<!--  Free Web Templates by TemplateMo.com  -->
  <div id="templatemo_header">
   	...
   	<div id="site_logo"><a href="index.php"><img src="../images/logo3.png"></a></div>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530" style="height:auto;">
        	
            <div class="header_02">Choose Node Type</div>
            
            
            
            
            <center><div id="form_cont" style="alignment-adjust:central; height: auto;">
		...
		<br>
            ...
            <form action="glfaults.php" method="post">
			 
        	<?php  
			
						$isql=mysqli_query($link,"SELECT isRoot FROM node WHERE fault_id='$f' AND isRoot='1'");
            ...
            <div class="all"><label>Choose Fault Type</label><select name="ndt" id="ndt">
            
           		
							<option value='1'>Root Fault</option>
                			
            </select></div>
             <div class="all"><label>Fault</label><input type="text" name="rootfault" id="rootfault"></div>
             <div class="all"><label>Basic Causes</label><textarea placeholder="Please Seperate Causes or Failures With ';' " name="bcause"></textarea></div>
			...
			?>
                ...
                <div class="all"><label>Choose Fault Type</label><select name="ndt" id="ndt">
							...
							<option value='2'>Dependent Fault</option>
                			
           		 </select></div>
            	<div class="all"><label>Fault</label><input type="text" name="fault"></div>
            	
            	<div class="all"><label>Basic Causes</label><textarea name="bcause" placeholder="Please Seperate Causes or Failures With ';'"></textarea></div>
            	<div class="all"><label>Symptoms</label><textarea name="symp" placeholder="Please Seperate Symptoms With ';'"></textarea></div>
            	<div class="all"><label>Solutions</label><textarea name="sol" placeholder="Please Seperate Solutions With ';'"></textarea></div>
                <div class="all"><label>Choose Depending Fault</label><select style="height:auto;" name="df" id="df"required>
            
           		
							<?php
                            
							$rt=mysqli_query($link,"SELECT id,problem FROM node WHERE fault_id='$f'");
							while(list($id,$problem)=mysqli_fetch_row($rt)){
								$problem=ucwords($problem);
								echo "<option value='$id'>$problem</option>";
        ...
        <div class="all"><label></label><button type="submit">Add Fault</button></div>
        </form>
