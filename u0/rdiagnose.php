<?php
namespace cliqs\fault\diagnose;
...
-->
        ...
        <form action="faults.php" method="post">


            <div class="all"><label>Vehicle Brand</label><select name="brand" id="brand">
            
            <?php	
				$isql0=mysqli_query($link,"SELECT * FROM carbrand");
				while(list($id,$brand)=mysqli_fetch_row($isql0)){
