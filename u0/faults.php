...
<title>Auto repair| Search</title>
		...
		<div id="templatemo_menu">
            ...
            <ul>
                  ...
                  <li><a href="clients.php">Clients</a></li>
               		<li><a href=<?php echo "diagnose.php?clt=$clt"; ?>>Back</a></li>
...
<div id="templatemo_content_wrapper">
	<div id="templatemo_content">
    	...
    	<div id="column_w530" style="overflow:hidden;">
        	
            <div class="header_02">Problem Analysis</div>
            
            
            
            
            <center><div id="form_cont" style="color:black; font-size:16px; font-family:amble;">
...
-->
			...
			$subsystem=$_SESSION['sbsys'];
				...
				$queryinput=$_SESSION['undesiredevent'];	
			
			
				
			
			 ?>
            <div class="search" style="color:black; margin-left:10%; text-align:start;">
            
				<?php					$record->getFaultList($f,$subsystem,$system,$queryinput);
				?>
